...
The most recent data used for this section are the **2016-2020 5-year estimates**. These estimates average all survey responses across this period to increase sample sizes and reduce margins of error.
...
b25003_vars <- load_variables(2023, "acs5") %>%
...
b25004_vars <- load_variables(2023, "acs5") %>%
