...
# from the variables. 
b19013_defns <- load_variables(2019, "acs5") %>%
...
b19049_defns <- load_variables(2019, "acs5") %>%
...
b25118_defns <- load_variables(2019, "acs5") %>%
...
# Create a column for 2019 dollar value (dollars19). 2019 CPI value is 376.5.

adjustment <- function(x){
  x %>%
    mutate(dollars19 = ((376.5/cpi_index)*estimate))
}

dollars19_dfs <- list(output_b19013_locality, output_b19013_cbsa, output_b19013_state,
                   output_b19049_locality, output_b19049_cbsa, output_b19049_state,
                   output_b25119_locality, output_b25119_cbsa, output_b25119_state) 

dollars19 <- dollars19_dfs %>%
  lapply(adjustment)

names(dollars19) = c('output_b19013_locality', 'output_b19013_cbsa', 'output_b19013_state',
                   'output_b19049_locality', 'output_b19049_cbsa', 'output_b19049_state',
                   'output_b25119_locality', 'output_b25119_cbsa', 'output_b25119_state')
