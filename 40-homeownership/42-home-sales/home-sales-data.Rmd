...
locality_data <- locality_raw %>%
  bind_rows(locality_2022Q1, locality_2022Q2, locality_2022Q3, locality_2022Q4, locality_2023Q1, locality_2023Q2, locality_2023Q3) %>% 
  mutate(geography = "Locality",
         .before = 1) %>% 
  rename(name = 'City County')

msa_data <- msa_raw %>% 
  bind_rows(msa_2022Q1, msa_2022Q2, msa_2022Q3, msa_2022Q4, msa_2023Q1, msa_2023Q2, msa_2023Q3) %>% 
