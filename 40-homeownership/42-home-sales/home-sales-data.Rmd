...
# setwd("C:/Users/Jonathan/Documents/repos/sourcebook/40-homeownership/42-home-sales")
...
var_2022Q2 <- "raw/var_2022-Q2.xlsx"

var_2022Q3 <- "raw/var_2022-Q3.xlsx"

var_2022Q4 <- "raw/var_2022-Q4.xlsx"

var_2023Q1 <- "raw/var_2023-Q1.xlsx"

var_2023Q2 <- "raw/var_2023-Q2.xlsx"

var_2023Q3 <- "raw/var_2023-Q3.xlsx"

var_2023Q4 <- "raw/var_2023-Q4.xlsx"

var_2024Q1 <- "raw/var_2024-Q1.xlsx"

var_2024Q2 <- "raw/var_2024-Q2.xlsx"

var_2024Q3 <- "raw/var_2024-Q3.xlsx"

var_2024Q4 <- "raw/var_2024-Q4.xlsx"
...
locality_data <- locality_raw %>%
  bind_rows(locality_2022Q1, locality_2022Q2, locality_2022Q3, locality_2022Q4, locality_2023Q1, locality_2023Q2, locality_2023Q3, locality_2023Q4, locality_2024Q1, locality_2024Q2, locality_2024Q3, locality_2024Q4) %>% 
  mutate(geography = "Locality",
         .before = 1) %>% 
  rename(name = 'City County')

msa_data <- msa_raw %>% 
  bind_rows(msa_2022Q1, msa_2022Q2, msa_2022Q3, msa_2022Q4, msa_2023Q1, msa_2023Q2, msa_2023Q3, msa_2023Q4, msa_2024Q1, msa_2024Q2, msa_2024Q3, msa_2024Q4) %>% 
