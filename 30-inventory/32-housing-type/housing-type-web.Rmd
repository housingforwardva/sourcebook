...
All homes are classified into one of the following seven categories:
...
* **Other** homes include boats, recreational vehicles (RVs), vans, and all other units that do not fall into one of the above categories.

Data is available at the state, CBSA, and locality level.
<br>
<br>
```{r dashboard}
knitr::include_url(url = "https://public.tableau.com/views/Sourcebook-DASHBOARD/Statewide?:showVizHome=no&:embed=true", height = "500px")
```
<br>
<br>
